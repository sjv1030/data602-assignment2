# -*- coding: utf-8 -*-
"""
Created on Mon Apr  2 12:59:30 2018
...
#    temp = pd.DataFrame.from_records([{'Time':hist_time,'Trade':trade, 
#                        'Ticker':tick.upper(),'Quantity':shares,
#                        'Executed Price':price,'Money In/Out':price*shares,
#                        'Cash': cash}],index='Time')
    p.update_audit(hist_time,trade,tick,shares,price,flag=0)
#    p.audit = p.audit.append(temp)
